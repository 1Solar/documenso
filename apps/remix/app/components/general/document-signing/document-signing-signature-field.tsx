...
export const DocumentSigningSignatureField = ({
  ...
  return (
    ...
    >
      ...
      {state === 'empty' && (
        <p className="group-hover:text-primary font-signature text-muted-foreground text-[clamp(0.575rem,2cqw,1.2rem)] text-xl duration-200 group-hover:text-yellow-300">
